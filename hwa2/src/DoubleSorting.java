...
public class DoubleSorting {
   ...
   public static void binaryInsertionSort(double[] a) {
      ...
      for (int i = 1; i < a.length; i++) {
         double key = a[i];
         int leftIndex = 0; //starting position of left index in always zero
         int rightIndex = i; //right index is the right most position of the already sorted part of the array
